  ...
  return (
    <div>
      <div className="flex bg-[#333333] items-center justify-between px-[150px] py-10">
        <div className="flex flex-col items-start gap-3">
          <div className="flex items-center gap-2">
            ...
            <p className="text-white font-bold text-2xl">Go Ecommerce </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button>
              <p className="text-white text-sm font-semibold">(010) 555-010</p>
              <div className="w-full bg-primary h-[2px]" />
            </button>
            <span className="text-gray500">or</span>
            <button>
              <p className="text-white  text-sm font-semibold">feralcode0x@gmail.com</p>
              <div className="w-full bg-primary h-[2px]" />
            </button>
          </div>
        </div>
      ...
      <div className="flex bg-[#333333] items-center justify-between px-[150px] py-3 gap-3">
        <p className="text-gray-500 text-sm">Go Ecommerce © 2026. All Rights Reserved</p>
        <div className="flex items-center gap-2">
